"""Applies Q-learning algorithm to grid-world environments.
"""
import sys
import numpy as np
import itertools
...
class QLearn:
    ...
    """Creates value and policy containers for Q-learning evaluation of a
    grid-world instance.
    ...
    def __init__(self, c_map, possible_actions, world, Q=None):
        """Initializes Q-learning parameters
    ...
    def update_Q(self, state, action, new_state, reward):
        ...
        self.Q[state, action] = q + self.alpha * \
            (reward + self.discount_factor *
             max(self.Q.get((new_state, a), 0.0) for a in self.possible_actions) - q)
